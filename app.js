...
document
  ...
  .addEventListener("click", function (event) {
    ...
    const mailtoLink = `mailto:evanschaun@gmail.com.com?subject=${encodeURIComponent(
      subject
    )}&body=${encodeURIComponent(
      message
    )}%0D%0A%0D%0AFrom:%0D%0A${encodeURIComponent(
      name
...
function viewFile(fileUrl) {
  ...
  if (extension === "pdf") {
    ...
    unsupportedMessage.textContent =
      "Unsupported file format. Cannot display the file.";
